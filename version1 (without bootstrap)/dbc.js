$(function(){
	...
	function won(){
	$("#frame label").html("");
	$("#frame label").html("<h4>Congratulations!!</h4> <h5>You Have Won </h5><h6> Your Score is "+score);
	$("#frame label").css("margin-top","-3px");
		$("#pause").click();
	...
	function missed()
	{
		...
		$("#frame label").html("<h4>You Missed it..</h4> <h5>Lives left : "+lives);
		$("#frame label").css("margin-top","-3px");
...
*/							/*$("#myCanvas").fadeIn();
							*/
							...
							drawScore();
							drawLives();
							$("#frame label").html("<b> GAME OVER !!!! </b>");
							$("#frame label").css("margin-top","24px");
